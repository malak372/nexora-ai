...
import { IntelligentAnalysisOutput } from './types/intelligent-analysis.types';
 ...
 * - Coordinate keyword, topic, problem, need, feature request, and opportunity extraction.
