...
14. Keep each evidence-backed label canonical and specific, for example: Application Reliability and Crash Failures, Navigation and Interface Failures, Document Access and Download Failures, Blockchain Transaction Execution and Smart Contract Revert Failures, Account Activation and Login Failures, Data Synchronization and Recovery Failures, Cross-Device Access Barriers, or Pricing and Paywall Restrictions. When an explicit technical failure signature such as transaction reverted, execution reverted, provider error, or gas estimation failure is present, classify the failure itself instead of wrapper workflow nouns such as document, email, sign, or file.
