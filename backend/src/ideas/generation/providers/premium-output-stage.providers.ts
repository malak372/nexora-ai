...
export const PREMIUM_OUTPUT_STAGE_TOKENS = {
  ...
  FEASIBILITY_ASSESSMENT: Symbol(
    'PREMIUM_STAGE_FEASIBILITY_ASSESSMENT',
  ),
  IMPLEMENTATION_TIMELINE: Symbol(
    'PREMIUM_STAGE_IMPLEMENTATION_TIMELINE',
  ),
  MARKET_POTENTIAL: Symbol('PREMIUM_STAGE_MARKET_POTENTIAL'),
  NLP_EXECUTIVE_SUMMARY: Symbol(
    'PREMIUM_STAGE_NLP_EXECUTIVE_SUMMARY',
  ),
...
export const PREMIUM_OUTPUT_STAGE_REGISTRATIONS = [
  ...
  {
    token:
      PREMIUM_OUTPUT_STAGE_TOKENS.IMPLEMENTATION_TIMELINE,
    stageKey:
      IDEA_GENERATION_STAGE_KEYS
  ...
  },
  {
    ...
    stageKey:
      IDEA_GENERATION_STAGE_KEYS.MARKET_POTENTIAL_GENERATION,
    outputKey: 'market-potential',
  },
  {
    token:
      PREMIUM_OUTPUT_STAGE_TOKENS.NLP_EXECUTIVE_SUMMARY,
    stageKey:
      IDEA_GENERATION_STAGE_KEYS
...
function createPremiumOutputStageOptions(
  ...
  return {
    definition: getRequiredStageDefinition(
...
export const PREMIUM_OUTPUT_STAGE_PROVIDERS: Provider[] =
  PREMIUM_OUTPUT_STAGE_REGISTRATIONS.map(
    createPremiumOutputStageProvider,
  );