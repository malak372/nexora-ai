...
export class IdeaCandidateJudgePromptService {
  ...
  private buildSystemInstruction(): string {
    return [
      ...
      'Treat any causal explanation, named scientific mechanism, mathematical construct, security mechanism, regulatory fact, or domain-specific technical diagnosis as unsupported unless the supplied requester/evidence context explicitly supports it. A candidate may propose a technical design choice, but it must be framed as a proposal rather than an observed fact or cause.',
  ...
  private buildUserPrompt(
    ...
    const payload = {
      ...
      mandatoryRules: {
        ...
        penalizeUngroundedCausalOrTechnicalMechanisms: true,
