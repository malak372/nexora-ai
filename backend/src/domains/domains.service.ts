...
export class DomainsService {
  ...
  private buildDomainsWhere(
    ...
    const isVisible =
      query.isVisible !== undefined ? query.isVisible === 'true' : undefined;
    ...
    return {
      ...
      ...buildExactFilter('isVisible', isVisible),
      ...buildExactFilter('isAutoGenerated', isAutoGenerated),
    };
  }
  ...
  async getDomains(query: GetDomainsQueryDto) {
    ...
    const orderBy = buildOrderBy(
      query,
      ['name', 'isActive', 'isVisible', 'isAutoGenerated', 'updatedAt', 'createdAt'] as const,
      'createdAt',
    );
  ...
  async updateDomain(id: string, body: UpdateDomainDto, adminId: string) {
    ...
    await this.auditLogsService.createLog({
      ...
      newValue: {
        ...
        isVisible: updatedDomain.isVisible,
        isAutoGenerated: updatedDomain.isAutoGenerated,
