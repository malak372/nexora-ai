 ...
 */
export type NotifyPaymentSucceededInput =
    BasePaymentNotificationInput;

/**
 * Input required to send a failed-payment notification.
 */
export type NotifyPaymentFailedInput =
    BasePaymentNotificationInput & {
        /**
...
export class PaymentNotificationService {
    ...
    private readonly logger = new Logger(
        PaymentNotificationService.name,
    );
    ...
    async notifyPaymentFailed(
        input: NotifyPaymentFailedInput,
    ): Promise<void> {
        try {
