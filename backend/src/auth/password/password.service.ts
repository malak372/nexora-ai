...
const PASSWORD_RESET_TOKEN_EXPIRES_MINUTES =
  15;
...
export class AuthPasswordService {
  ...
  /**
   * Requests forgotten-password reset.
   *
   * resetClient determines whether the reset email points to
   * the web application or the native mobile deep link.
   */
  async forgotPassword(
    ...
    const response = {
      message:
        PASSWORD_RESET_REQUEST_RESPONSE_MESSAGE,
    };
    ...
    /*
     * Expire all previous unused reset tokens.
     */
      ...
      await this.authAuditService.createLog(
        {
          ...
          action:
            AuthAction.RESET_PASSWORD_FAILED,
