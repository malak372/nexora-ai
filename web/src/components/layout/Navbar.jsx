...
export default function Navbar() {
    ...
    return (
        <header className="vox-public-header sticky top-0 z-50">
            <div
                className={`vox-public-header__inner mx-auto flex w-full items-center justify-between border transition-all duration-300 ${isScrolled
            ...
            {isMenuOpen && (
                <div className="vox-public-header__mobile-menu mx-auto mt-3 w-full rounded-[1.5rem] border border-[#deece8] bg-white/95 p-4 shadow-[0_18px_45px_rgba(42,77,67,0.12)] backdrop-blur-xl lg:hidden">
