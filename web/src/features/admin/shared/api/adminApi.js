...
const post = async (url, body, config = {}) => extractApiData(await normalUserApi.post(url, body, config));
const patch = async (url, body, config = {}) => extractApiData(await normalUserApi.patch(url, body, config));
const del = async (url, config = {}) => extractApiData(await normalUserApi.delete(url, config));
...
export const adminApi = {
  sensitiveAccess: {
    verify: (scope, password) => post('/admin/sensitive-access/verify', { scope, password }),
  },
  ...
  administrators: {
    workspace: (accessToken) => get(
      ...
      undefined,
      sensitiveConfig(accessToken, { timeout: 20000 }),
    ),
    invite: (body, accessToken) => post(
      '/admin/administrators/invitations',
      body,
      sensitiveConfig(accessToken, { timeout: 60000 }),
    ),
  ...
  payments: {
    list: (params) => adminRead('payments-list', '/admin/payments', params, 30000),
    listFresh: (params) => freshGet('payments-list', '/admin/payments', params, 20000, { timeout: 12000 }),
    summary: (params) => adminRead('payments-summary', '/admin/payments/summary', params, 60000),
    summaryFresh: (params) => freshGet('payments-summary', '/admin/payments/summary', params, 45000, { timeout: 12000 }),
    charts: (params) => adminRead('payments-charts', '/admin/payments/charts', params, 120000),
    chartsFresh: (params) => freshGet('payments-charts', '/admin/payments/charts', params, 90000, { timeout: 12000 }),
    exportCsv: (params) => downloadCsv('/admin/payments/export/csv', params, 'admin-payments.csv'),
  },
  credits: {
    list: (params) => adminRead('credits-list', '/admin/credits/history', params, 30000),
    listFresh: (params) => freshGet('credits-list', '/admin/credits/history', params, 20000, { timeout: 12000 }),
    summary: (params) => adminRead('credits-summary', '/admin/credits/summary', params, 60000),
    summaryFresh: (params) => freshGet('credits-summary', '/admin/credits/summary', params, 45000, { timeout: 12000 }),
    charts: (params) => adminRead('credits-charts', '/admin/credits/charts', params, 120000),
    chartsFresh: (params) => freshGet('credits-charts', '/admin/credits/charts', params, 90000, { timeout: 12000 }),
    adjust: async (body) => {
      const value = await post('/admin/credits/adjust', body);
  ...
  domains: {
    list: (params) => adminRead('domains-list', '/admin/domains', params, 30000),
    ...
    create: async (body) => {
      const value = await post('/admin/domains', body);
    ...
    update: async (id, body) => {
      const value = await patch(`/admin/domains/${id}`, body);
      invalidateAdminCache('domains-list');
      invalidateAdminCache('domains-summary');
      invalidateAdminCache('domains-charts');
      invalidateAdminCache('dashboard');
    ...
    remove: async (id) => {
      const value = await del(`/admin/domains/${id}`);
      invalidateAdminCache('domains-list');
      invalidateAdminCache('domains-summary');
      invalidateAdminCache('domains-charts');
      invalidateAdminCache('dashboard');
  ...
  alerts: {
    list: (params) => adminRead('alerts-list', '/admin/alerts', params, 30000),
    listFresh: (params) => freshGet('alerts-list', '/admin/alerts', params, 20000, { timeout: 12000 }),
    summary: (params) => adminRead('alerts-summary', '/admin/alerts/summary', params, 60000),
    summaryFresh: (params) => freshGet('alerts-summary', '/admin/alerts/summary', params, 45000, { timeout: 12000 }),
    sent: (params) => freshGet('alerts-sent', '/admin/alerts/sent', params, 15000, { timeout: 12000 }),
    sentFresh: (params) => freshGet('alerts-sent', '/admin/alerts/sent', params, 15000, { timeout: 12000 }),
    send: async (body) => {
      const value = await post('/admin/alerts/send', body);
    ...
    create: async (body) => {
      const value = await post('/admin/alerts', body);
      invalidateAdminCache('alerts-list');
      invalidateAdminCache('alerts-summary');
      invalidateAdminCache('alerts-sent');
      invalidateAdminCache('audit-list');
    ...
    email: async (body) => {
      const value = await post('/admin/alerts/email', body);
      invalidateAdminCache('alerts-sent');
      invalidateAdminCache('audit-list');
      invalidateAdminCache('audit-summary');
      invalidateAdminCache('dashboard');
  ...
  dataSources: {
    list: (params) => adminRead('data-sources-list', '/admin/data-sources', params, 30000),
    summary: () => adminRead('data-sources-summary', '/admin/data-sources/summary', undefined, 60000),
    create: async (body) => {
      const value = await post('/admin/data-sources', body);
    ...
    synchronize: async () => {
      const value = await post('/admin/data-sources/synchronize');
      invalidateAdminCache('data-sources-list');
      invalidateAdminCache('data-sources-summary');
    ...
    update: async (id, body) => {
      const value = await patch(`/admin/data-sources/${id}`, body);
      invalidateAdminCache('data-sources-list');
      invalidateAdminCache('data-sources-summary');
      invalidateAdminCache('data-source-detail');
      invalidateAdminCache('dashboard');
    ...
    status: async (id, isActive) => {
      const value = await patch(`/admin/data-sources/${id}/status`, { isActive });
      invalidateAdminCache('data-sources-list');
      invalidateAdminCache('data-sources-summary');
      invalidateAdminCache('data-source-detail');
      invalidateAdminCache('dashboard');
  ...
  aiModels: {
    list: (params) => adminRead('ai-models-list', '/ai-models', params, 30000),
    listFresh: (params) => freshGet('ai-models-list', '/ai-models', params, 20000, { timeout: 12000 }),
    summary: () => adminRead('ai-models-summary', '/ai-models/summary', undefined, 60000),
    summaryFresh: () => freshGet('ai-models-summary', '/ai-models/summary', undefined, 45000, { timeout: 12000 }),
    ...
    create: async (body) => {
      const value = await post('/ai-models', body);
    ...
    update: async (id, body) => {
      const value = await patch(`/ai-models/${id}`, body);
      invalidateAdminCache('ai-models-list');
      invalidateAdminCache('ai-models-summary');
      invalidateAdminCache('ai-model-detail');
      invalidateAdminCache('dashboard');
    ...
    setDefault: async (id) => {
      const value = await patch(`/ai-models/${id}/default`, {});
      invalidateAdminCache('ai-models-list');
      invalidateAdminCache('ai-models-summary');
      invalidateAdminCache('ai-model-detail');
      invalidateAdminCache('dashboard');
    ...
    activate: async (id) => {
      const value = await patch(`/ai-models/${id}/activate`, {});
      invalidateAdminCache('ai-models-list');
      invalidateAdminCache('ai-models-summary');
      invalidateAdminCache('ai-model-detail');
      invalidateAdminCache('dashboard');
    ...
    deactivate: async (id) => {
      const value = await patch(`/ai-models/${id}/deactivate`, {});
      invalidateAdminCache('ai-models-list');
      invalidateAdminCache('ai-models-summary');
      invalidateAdminCache('ai-model-detail');
      invalidateAdminCache('dashboard');
    ...
    remove: async (id) => {
      const value = await del(`/ai-models/${id}`);
      invalidateAdminCache('ai-models-list');
      invalidateAdminCache('ai-models-summary');
      invalidateAdminCache('ai-model-detail');
  ...
  aiMonitoring: {
    list: (params) => adminRead('ai-monitoring-list', '/admin/ai-monitoring/logs', params, 15000),
    listFresh: (params) => freshGet('ai-monitoring-list', '/admin/ai-monitoring/logs', params, 15000, { timeout: 12000 }),
    summary: (params) => adminRead('ai-monitoring-summary', '/admin/ai-monitoring/summary', params, 30000),
    summaryFresh: (params) => freshGet('ai-monitoring-summary', '/admin/ai-monitoring/summary', params, 30000, { timeout: 12000 }),
    charts: (params) => adminRead('ai-monitoring-charts', '/admin/ai-monitoring/charts', params, 120000),
    chartsFresh: (params) => freshGet('ai-monitoring-charts', '/admin/ai-monitoring/charts', params, 120000, { timeout: 12000 }),
  ...
  aiAnalytics: {
    summary: (params) => adminRead('ai-analytics-summary', '/admin/ai/analytics/summary', params, 120000, { timeout: 12000 }),
    summaryFresh: (params) => freshGet('ai-analytics-summary', '/admin/ai/analytics/summary', params, 120000, { timeout: 12000 }),
  },
  auditLogs: {
    list: (params) => adminRead('audit-list', '/audit-logs', params, 30000),
    listFresh: (params) => freshGet('audit-list', '/audit-logs', params, 20000, { timeout: 12000 }),
    summary: (params) => adminRead('audit-summary', '/audit-logs/summary', params, 60000),
    summaryFresh: (params) => freshGet('audit-summary', '/audit-logs/summary', params, 45000, { timeout: 12000 }),
    charts: (params) => adminRead('audit-charts', '/audit-logs/charts', params, 120000),
    chartsFresh: (params) => freshGet('audit-charts', '/audit-logs/charts', params, 60000, { timeout: 12000 }),
    exportCsv: (params) => downloadCsv('/audit-logs/export/csv', params, 'admin-audit-logs.csv'),
  },
  authAudit: {
    list: (params) => adminRead('auth-audit-list', '/admin/auth-audit-logs', params, 30000),
    listFresh: (params) => freshGet('auth-audit-list', '/admin/auth-audit-logs', params, 20000, { timeout: 12000 }),
    summary: (params) => adminRead('auth-audit-summary', '/admin/auth-audit-logs/summary', params, 60000),
    summaryFresh: (params) => freshGet('auth-audit-summary', '/admin/auth-audit-logs/summary', params, 45000, { timeout: 12000 }),
  },
  collection: {
    ...
    run: async (body) => {
      const value = await post('/data-collection/run', body);
    ...
    stop: async (id) => {
      const value = await post(`/data-collection/${id}/stop`, {});
      invalidateAdminCache('collection-jobs');
      invalidateAdminCache('collection-status');
      invalidateAdminCache('collection-detail');
      invalidateAdminCache('dashboard');
  ...
  prompts: {
    template: () => adminRead('prompts-template', '/prompts/template', undefined, 60000),
    templateFresh: () => freshGet('prompts-template', '/prompts/template', undefined, 45000, { timeout: 12000 }),
    history: (params) => adminRead('prompts-history', '/prompts/history', params, 30000),
    historyFresh: (params) => freshGet('prompts-history', '/prompts/history', params, 20000, { timeout: 12000 }),
    update: async (body) => {
      const value = await patch('/prompts/template', body);
  ...
  settings: {
    get: (accessToken) => get('/admin/settings', undefined, sensitiveConfig(accessToken)),
    getFresh: (accessToken) => get('/admin/settings', undefined, {
      ...sensitiveConfig(accessToken),
      timeout: 12000,
    }),
    update: async (body, accessToken) => {
      const value = await patch('/admin/settings', body, sensitiveConfig(accessToken));
      invalidateAdminCache('audit-list');
      invalidateAdminCache('audit-summary');
      invalidateAdminCache('dashboard');
      return value;
...
const prefetchAdminRoute = (pathname) => {
  const createdDesc = { page: 1, limit: 20, sortBy: 'createdAt', sortOrder: 'desc' };

  const loaders = {
    '/admin/dashboard': () => adminApi.getDashboard(),
    '/admin/users': () => adminApi.users.list(createdDesc),
    '/admin/ideas': () => adminApi.ideas.list(createdDesc),
    '/admin/publication-reports': () => adminApi.publicationReports.list(createdDesc),
    '/admin/evidence': () => adminApi.evidence.list({ page: 1, limit: 20, sortBy: 'collectedAt', sortOrder: 'desc' }),
    '/admin/payments': () => adminApi.payments.list(createdDesc),
    '/admin/credits': () => adminApi.credits.list(createdDesc),
    '/admin/complaints': () => adminApi.complaints.list(createdDesc),
    '/admin/contact-messages': () => adminApi.contactMessages.list(createdDesc),
    '/admin/ai-monitoring': () => adminApi.aiMonitoring.list(createdDesc),
    '/admin/ai-analytics': () => adminApi.aiAnalytics.summary({}),
    '/admin/ai-models': () => adminApi.aiModels.list({ page: 1, limit: 20, sortBy: 'priority', sortOrder: 'desc' }),
    '/admin/data-sources': () => Promise.allSettled([
      adminApi.dataSources.list({ page: 1, limit: 20 }),
    ...
    '/admin/domains': () => adminApi.domains.list({ page: 1, limit: 20, sortBy: 'name', sortOrder: 'asc' }),
    '/admin/audit-logs': () => adminApi.auditLogs.list(createdDesc),
    '/admin/auth-audit': () => adminApi.authAudit.list(createdDesc),
