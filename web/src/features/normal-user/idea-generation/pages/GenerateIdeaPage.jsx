  ...
  useEffect(() => {
    ...
    getNormalUserSummary({ force: true })
      .then((summary) => {
        ...
        setGenerationBlocked(premium ? credits <= 0 : remaining <= 0);
      })
      .catch(() => {
    ...
    try {
      const response = await startIdeaGeneration({
        ...(selectedDomainIds.length
          ...
          : {}),
        generationType: isPremium ? GENERATION_TYPES.PREMIUM_CREDIT : GENERATION_TYPES.NORMAL_FREE,
